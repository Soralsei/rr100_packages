...
from rr100_rl.utils.helpers import flatten
from rr100_rl.utils.helpers import ros_exit_gracefully
...
class ControllersConnection:
    ...
    def gazebo(self):
        ...
        return any(
            ["/gazebo" in topic for topic in flatten(rospy.get_published_topics())]
        )
    ...
    def gazebo_paused(self):
        ...
        if self.gazebo and any(
            ["/clock" in topic for topic in flatten(rospy.get_published_topics())]
        ):
            try:
